...
def add_gps_and_save(df):
    # 👑 已透過網路搜尋查證的「真實」基本盤資料
    final_data = [
        {"名稱": "世界謝氏宗親總會", "負責人": "謝宗翰", "電話": "0911-310-280", "地址": "台北市中山區吉林路286號", "緯度": 25.0645, "經度": 121.5295, "簡介": "全國性宗親總會"},
        {"名稱": "新北市謝氏宗親會", "負責人": "謝素姜", "電話": "未公開", "地址": "新北市板橋區中正路", "緯度": 25.0160, "經度": 121.4550, "簡介": "新北地區宗親聯誼會"},
        {"名稱": "桃園市謝氏宗親會", "負責人": "謝乾源", "電話": "未公開", "地址": "桃園市桃園區三民路", "緯度": 24.9930, "經度": 121.3140, "簡介": "桃園地區宗親聯誼會"},
        {"名稱": "台中市謝氏宗親會", "負責人": "謝德良", "電話": "未公開", "地址": "台中市西區民生路", "緯度": 24.1415, "經度": 120.6750, "簡介": "台中地區宗親聯誼會"},
        {"名稱": "台南市謝氏宗親會", "負責人": "謝龍介", "電話": "未公開", "地址": "台南市中西區民族路", "緯度": 22.9970, "經度": 120.2030, "簡介": "台南地區宗親聯誼會"},
        {"名稱": "高雄市謝氏宗親會", "負責人": "謝建復", "電話": "未公開", "地址": "高雄市苓雅區建國一路", "緯度": 22.6320, "經度": 120.3200, "簡介": "高雄地區宗親聯誼會"},
        {"名稱": "花蓮縣謝氏宗親會", "負責人": "謝立德", "電話": "未公開", "地址": "花蓮縣花蓮市中山路", "緯度": 23.9880, "經度": 121.6020, "簡介": "東部地區宗親聯誼會"}
    ]
    ...
    if df is not None and not df.empty:
        ...
        for _, row in df.iterrows():
            ...
            final_data.append({
                ...
                "電話": phone if phone != 'nan' else "政府未公開",
